...
(6) Add an event listener to the search button. When the user clicks on the button it should use the text in the search input to filter the results. Searching should be case insensitive. e.g. a search for “Susan” should return results for “susan” and “Susan".
...
//////Search results to feed into and/or run the pagination function
(8) Search results should also be paginated. For example, if the search returns more than 10 results, those results should be paginated too. You will need to be accomplish this without the use of jQuery plugins or any other library plugins.
...
/*
(10) Include simple animations when transitioning between pages.

(11) As the user types in the search box, dynamically filter the student listings. In other words, after each letter is typed into the search box, display any listings that match .

(12) If no matches are found, include a message in the HTML to tell the user there are no matches.
